...
public class MainTabActivity extends TabActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		tabhost.addTab(tabhost
				.newTabSpec("iHome")
				.setIndicator(getResources().getString(R.string.main_plan),
		...
		tabhost.addTab(tabhost
				.newTabSpec("iNews")
				.setIndicator(getResources().getString(R.string.main_add),
		...
		tabhost.addTab(tabhost
				.newTabSpec("iInfo")
				.setIndicator(getResources().getString(R.string.main_list),
